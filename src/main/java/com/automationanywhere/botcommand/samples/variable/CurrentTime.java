...
@CommandPkg(description = "Returns current time as HH:mm:ss as String", name = "CurrentTime", label = "CurrentTime", variable_return_type = DataType.STRING)

public class CurrentTime {
    @VariableExecute
    public StringValue get() {
        return new StringValue(SharedFunctions.getCurrentTime());
    }
}
