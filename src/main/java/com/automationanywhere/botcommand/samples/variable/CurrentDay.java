...
@CommandPkg(description = "Returns current 2 digit day date", name = "CurrentDay", label = "CurrentDay", variable_return_type = DataType.STRING)
public class CurrentDay {
    @VariableExecute
    public StringValue get() {
        return new StringValue(SharedFunctions.getCurrentDay());
    }
}
