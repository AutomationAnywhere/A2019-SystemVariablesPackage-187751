...
@CommandPkg(description = "Returns current 2 digit month", name = "CurrentMonth", label = "CurrentMonth", variable_return_type = DataType.STRING)
public class CurrentMonth {
    @VariableExecute
    public StringValue get() {
        return new StringValue(SharedFunctions.getCurrentMonth());
    }
}
