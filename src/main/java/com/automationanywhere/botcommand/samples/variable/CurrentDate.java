...
@CommandPkg(description = "Returns current date as MM-dd-yyyy as String", name = "CurrentDate", label = "CurrentDate", variable_return_type = DataType.STRING)

public class CurrentDate {
    @VariableExecute
    public StringValue get() {
        return new StringValue(SharedFunctions.getCurrentDate());
    }
}
