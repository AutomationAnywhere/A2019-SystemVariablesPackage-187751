...
@CommandPkg(description = "Returns working directory", name = "UserWorkingDirectory", label = "UserWorkingDirectory", variable_return_type = DataType.STRING)
public class UserWorkingDirectory {
    @VariableExecute
    public StringValue get() {
        return new StringValue(SharedFunctions.getCurrentWorkingDir());
    }
}
