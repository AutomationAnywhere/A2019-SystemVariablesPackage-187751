...
public final class UserDownloadsDirectoryVariable implements SystemVariable<StringValue> {
  private static final Logger logger = LogManager.getLogger(UserDownloadsDirectoryVariable.class);

  private static final Messages MESSAGES_GENERIC = MessagesFactory.getMessages("com.automationanywhere.commandsdk.generic.messages");

  private final UserDownloadsDirectory command = new UserDownloadsDirectory();
  ...
  public StringValue get(GlobalSessionContext globalSessionContext) {
    logger.traceEntry();
    UserDownloadsDirectory command = new UserDownloadsDirectory();
