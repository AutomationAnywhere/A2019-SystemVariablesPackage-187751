...
public final class OperatingSystemArchVariable implements SystemVariable<StringValue> {
  private static final Logger logger = LogManager.getLogger(OperatingSystemArchVariable.class);

  private static final Messages MESSAGES_GENERIC = MessagesFactory.getMessages("com.automationanywhere.commandsdk.generic.messages");

  private final OperatingSystemArch command = new OperatingSystemArch();
  ...
  public StringValue get(GlobalSessionContext globalSessionContext) {
    logger.traceEntry();
    OperatingSystemArch command = new OperatingSystemArch();
