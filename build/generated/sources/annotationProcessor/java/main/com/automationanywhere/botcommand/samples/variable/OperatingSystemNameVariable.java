...
public final class OperatingSystemNameVariable implements SystemVariable<StringValue> {
  private static final Logger logger = LogManager.getLogger(OperatingSystemNameVariable.class);

  private static final Messages MESSAGES_GENERIC = MessagesFactory.getMessages("com.automationanywhere.commandsdk.generic.messages");

  private final OperatingSystemName command = new OperatingSystemName();
  ...
  public StringValue get(GlobalSessionContext globalSessionContext) {
    logger.traceEntry();
    OperatingSystemName command = new OperatingSystemName();
