...
public final class PublicIPAddressVariable implements SystemVariable<StringValue> {
  private static final Logger logger = LogManager.getLogger(PublicIPAddressVariable.class);

  private static final Messages MESSAGES_GENERIC = MessagesFactory.getMessages("com.automationanywhere.commandsdk.generic.messages");

  private final PublicIPAddress command = new PublicIPAddress();
  ...
  public StringValue get(GlobalSessionContext globalSessionContext) {
    logger.traceEntry();
    PublicIPAddress command = new PublicIPAddress();
