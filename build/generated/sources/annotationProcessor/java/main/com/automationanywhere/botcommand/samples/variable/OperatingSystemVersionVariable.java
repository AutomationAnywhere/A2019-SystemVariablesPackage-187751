...
public final class OperatingSystemVersionVariable implements SystemVariable<StringValue> {
  private static final Logger logger = LogManager.getLogger(OperatingSystemVersionVariable.class);

  private static final Messages MESSAGES_GENERIC = MessagesFactory.getMessages("com.automationanywhere.commandsdk.generic.messages");

  private final OperatingSystemVersion command = new OperatingSystemVersion();
  ...
  public StringValue get(GlobalSessionContext globalSessionContext) {
    logger.traceEntry();
    OperatingSystemVersion command = new OperatingSystemVersion();
