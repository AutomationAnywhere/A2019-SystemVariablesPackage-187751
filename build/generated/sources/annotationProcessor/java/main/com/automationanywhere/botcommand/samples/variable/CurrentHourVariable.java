...
public final class CurrentHourVariable implements SystemVariable<StringValue> {
  private static final Logger logger = LogManager.getLogger(CurrentHourVariable.class);

  private static final Messages MESSAGES_GENERIC = MessagesFactory.getMessages("com.automationanywhere.commandsdk.generic.messages");

  private final CurrentHour command = new CurrentHour();
  ...
  public StringValue get(GlobalSessionContext globalSessionContext) {
    logger.traceEntry();
    CurrentHour command = new CurrentHour();
