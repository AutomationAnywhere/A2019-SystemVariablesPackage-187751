...
public final class UserHomeDirectoryVariable implements SystemVariable<StringValue> {
  private static final Logger logger = LogManager.getLogger(UserHomeDirectoryVariable.class);

  private static final Messages MESSAGES_GENERIC = MessagesFactory.getMessages("com.automationanywhere.commandsdk.generic.messages");

  private final UserHomeDirectory command = new UserHomeDirectory();
  ...
  public StringValue get(GlobalSessionContext globalSessionContext) {
    logger.traceEntry();
    UserHomeDirectory command = new UserHomeDirectory();
