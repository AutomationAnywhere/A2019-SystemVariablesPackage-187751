...
public final class CurrentMinuteVariable implements SystemVariable<StringValue> {
  private static final Logger logger = LogManager.getLogger(CurrentMinuteVariable.class);

  private static final Messages MESSAGES_GENERIC = MessagesFactory.getMessages("com.automationanywhere.commandsdk.generic.messages");

  private final CurrentMinute command = new CurrentMinute();
  ...
  public StringValue get(GlobalSessionContext globalSessionContext) {
    logger.traceEntry();
    CurrentMinute command = new CurrentMinute();
