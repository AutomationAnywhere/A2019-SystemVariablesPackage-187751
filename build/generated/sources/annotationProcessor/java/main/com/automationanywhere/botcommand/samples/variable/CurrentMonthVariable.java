...
public final class CurrentMonthVariable implements SystemVariable<StringValue> {
  private static final Logger logger = LogManager.getLogger(CurrentMonthVariable.class);

  private static final Messages MESSAGES_GENERIC = MessagesFactory.getMessages("com.automationanywhere.commandsdk.generic.messages");

  private final CurrentMonth command = new CurrentMonth();
  ...
  public StringValue get(GlobalSessionContext globalSessionContext) {
    logger.traceEntry();
    CurrentMonth command = new CurrentMonth();
