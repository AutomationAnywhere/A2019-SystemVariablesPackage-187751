...
public final class UserWorkingDirectoryVariable implements SystemVariable<StringValue> {
  private static final Logger logger = LogManager.getLogger(UserWorkingDirectoryVariable.class);

  private static final Messages MESSAGES_GENERIC = MessagesFactory.getMessages("com.automationanywhere.commandsdk.generic.messages");

  private final UserWorkingDirectory command = new UserWorkingDirectory();
  ...
  public StringValue get(GlobalSessionContext globalSessionContext) {
    logger.traceEntry();
    UserWorkingDirectory command = new UserWorkingDirectory();
